...
How to obtain a summary of the model (notice that to proper display the results as html on a Rmarkdown chunk you have to set result as 'asis'. Other possible format include "numeric", useful to retrieve the statistics and use them in calculations, and "latex".)
```{r, results='asis'}
